...
import (
	...
	"github.com/sheacloud/flowsys/internal/collection/httpapi/routes"
...
func GetRouter(kinesisConfig output.KinesisStreamConfig) (*gin.Engine, error) {
	installLogrusLogger(router)
	installCustomRecovery(router)

	routes.AddFlowsRoutes(&router.RouterGroup, kinesisConfig)
